    ...
    const handleCalculateShipping = async () => {
        try {
            ...
            const response = await fetch(
                `https://13.233.74.89:8443/calculate-shipping-rates/${isSweden.toString()}/${isEurope.toString()}/${isTracable.toString()}/${isNonTracable.toString()}/${orderWeight}`
            );
                                ...
                                <PayPalButtons
                                    ...
                                    createOrder={(data, actions) => {
                                        ...
                                        return new Promise(async (resolve, reject) => {
                                            try {
                                                const response = await fetch(
                                                    `https://13.233.74.89:8443/calculate-shipping-rates/${selectedIsSweden}/${selectedisEurope}/${selectedisTracable}/${selectedisNonTracable}/${orderWeight}`
                                                );
                                                if (response.ok) {
                                                    const result = await response.json();
